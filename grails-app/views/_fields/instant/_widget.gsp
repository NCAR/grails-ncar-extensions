...
%><g:set var="localValue" value="${java.time.LocalDateTime.ofInstant(value,java.time.ZoneId.of('Z'))}"
...
/>&nbsp;T&nbsp;<input type="text" name="${property}_hour" id="${property}_hour" aria-labelledby="${property}" title="hour" value="${value ? DatetimeFormatters.formatHour(localValue) : ''}" size="2" maxlength="2" tabindex="1"
